...
#                        fontsize=annotation_fontsize, color=color, weight='bold')
...
if len(data) > 0:
    ...
    dhbl_orange = data[(data["type"] == "HSP")]
    dibl_cyan = data[(data["type"] == "ISP")]
    dlbl_blue = data[(data["type"] == "LSP")]
    dother_black = data[((data["type"] == "Unknown") | (data["type"] == "jetted-AGN")) & (data["ddec"] < 90.)]
    ...
    dhbl_orange, dibl_cyan, dlbl_blue, dother_black, dpulsar_purple = [pd.DataFrame()] * 5
...
if len(data2) > 0:
    ...
    dlblsmall_blue = data2[(data2["code"] > 30000) & (data2["radiocode"] <= 30)]
    dlblmedium_blue = data2[(data2["code"] > 30000) & (data2["radiocode"] > 30) & (data2["radiocode"] <= 60)]
    dlbllarge_blue = data2[(data2["code"] > 30000) & (data2["radiocode"] > 60)]
    ...
    dgamma = data2[(data2["code"] == -1111) & (data2["ddec2"] < 90.)]
else:
    # If the data is missing
    ...
    dmilliquas, dgrb, d4lac, dclusters, dgamma = [pd.DataFrame()] * 4
...
if len(data) > 0:
   ...
   if catsonly != 'y':
      ...
      bzb_size = 1.0
      # HBL objects.
      plot_points(dhbl_orange, ax_map, marker='o', marker_size=markersize_orange, color='#ff9933',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      # IBL objects.
      plot_points(dibl_cyan, ax_map, marker='o', marker_size=markersize_cyan, color='#66ffff',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      # LBL objects.
      plot_points(dlbl_blue, ax_map, marker='o', marker_size=markersize_blue, color='#0033cc',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      # Unknown type or Non-jetted AGN.
      plot_points(dother_black, ax_map, marker='$\\bigodot$', marker_size=markersize, color='black',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
   ...
   # Pulsars.
   plot_points(dpulsar_purple, ax_map, marker='p', marker_size=markersize_catalogued, color='#8000ff',
               marker_edge_width=marker_edge_width)
...
if len(data2) > 0:
   if catsonly != 'y':
      plot_points(dhblsmall_orange, ax_map, marker='o', marker_size=markersize_orange * 2, color='#ff9933',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dhblmedium_orange, ax_map, marker='o', marker_size=markersize_orange * 3, color='#ff9933',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dhbllarge_orange, ax_map, marker='o', marker_size=markersize_orange * 5, color='#ff9933',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(diblsmall_cyan, ax_map, marker='o', marker_size=markersize_cyan * 2, color='#66ffff',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(diblmedium_cyan, ax_map, marker='o', marker_size=markersize_cyan * 3, color='#66ffff',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dibllarge_cyan, ax_map, marker='o', marker_size=markersize_cyan * 5, color='#66ffff',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dlblsmall_blue, ax_map, marker='o', marker_size=markersize_blue * 2, color='#0033cc',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dlblmedium_blue, ax_map, marker='o', marker_size=markersize_blue * 3, color='#0033cc',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      plot_points(dlbllarge_blue, ax_map, marker='o', marker_size=markersize_blue * 5, color='#0033cc',
                  marker_edge_width=marker_edge_width_hbl_ibl_lbl)
      ...
      plot_points(dcrates_large, ax_map, marker='o', marker_size=markersize_blue * 5, color='#e70b5c',
                  marker_edge_width=marker_edge_width)
      # Possible cluster 
      plot_points(dclusters, ax_map, marker='$?$', marker_size=markersize_catalogued * 2.5, color='#ffcc00',
                  marker_edge_width=marker_edge_width, marker_face_color='None')
      # Milliquas sources
